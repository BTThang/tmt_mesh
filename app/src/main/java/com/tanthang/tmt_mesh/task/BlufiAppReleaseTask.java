package com.tanthang.tmt_mesh.task;
...
public class BlufiAppReleaseTask {
    ...
    private static final String KEY_ASSETS_NAME = "name";
    ...
    private ReleaseInfo parseRelease(JSONObject releaseJSON) {
        try {
            ...
            for (int i = 0; i < assetArray.length(); i++) {
                ...
                String assetName = assetJSON.getString(KEY_ASSETS_NAME);
    ...
    public static class ReleaseInfo {
        ...
        public String toString() {
            return String.format(Locale.ENGLISH, "VersionName=%s, VersionCode=%d, DownloadUrl=%s, APKSize = %d, notes= %s", versionName, versionCode, downloadUrl, apkSize, notes);
        }
    }
