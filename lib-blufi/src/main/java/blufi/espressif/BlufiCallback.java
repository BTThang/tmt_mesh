...
public abstract class BlufiCallback {
    ...
    /**
     * Callback invoked when received device scan results custommmmmm
     *
     * @param client BlufiClient
     * @param status {@link #STATUS_SUCCESS} means response is valid
     * @param results scan result list
     */
    public void onDeviceCustomResult(BlufiClient client, int status, List<BlufiCustomResult> results) {
    }
